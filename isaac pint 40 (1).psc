...
Algoritmo ejercicios
	...
	Definir frase, letra ,opc,tecla Como Caracter
	...
	Mientras opc <> "40" Hacer
		...
		Segun opc Hacer
			...
			"9":
				...
				Escribir "=============================================="
				Escribir "Ingrese que cargo es (estudiante=1,administrador=2,docente=3   ";leer n1
				se(n1)
			"10": 
				Escribir "=============================================="
			...
			"15":
				...
				Escribir "=============================================="
				Escribir "Ingrese numeros a evaluar ";leer n1
				Escribir "Ingrese el multplo necesario";leer n2
				mulnum(n1,n2)
			"16":
				Escribir "=============================================="
			...
			"18":
				...
				Escribir "=============================================="
				Escribir "Ingrese el valor con exponete";leer n1
				Escribir "Ingrese cuanatas veces se multiplica o exponente";leer n2
				ptn(n1,n2)
			"19":
				Escribir "=============================================="
				Escribir "     EJERCICIO FACTORIAL "
				Escribir "=============================================="
				Escribir "Ingrese numeros a a calcular el factorial  ";leer n1
				fac(n1)
			"20":
				Escribir "=============================================="
				Escribir "     EJERCICIO DIVISORES  "
				Escribir "=============================================="
				Escribir "Ingrese numeros a calcular los divisores  ";leer n1
				div(n1)
			"21":
				Escribir "=============================================="
			...
			"23":
				...
				Escribir "=============================================="
				Escribir "Ingrese numeros para serie fibonacci";leer n1
				fi(n1)
			"24":
				Escribir "=============================================="
				Escribir "     EJERCICIO CONTAREES DE PARES "
				Escribir "=============================================="
				Escribir "Ingrese numeros ";leer n1
				conpa(n1)
			"26":
				Escribir "=============================================="
